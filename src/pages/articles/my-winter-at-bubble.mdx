...
Each day, Bubble's no-code platform introduces new people to the joy and magic of building software. At its core, Bubble is a platform that enables anyone to build web apps without code. It's a flexible tool that pushes the limit of what you can do without code further than any other tool.

### Products

Bubble is the only tool that lets you build an Airbnb or a Twitter without code, because it's completely open-ended. People use Bubble to start companies, and we're seeing users increasingly use Bubble for products, internal or external, for existing companies and organizations.

In general, you can build interactive multi-user apps, including marketplaces like Uber, social networks like Facebook, SaaS like CRMs, and more.
...
Apps built on Bubble are scalable and performant. We've seen apps raise millions, get into YCombinator, etc. Comet in France scaled to $1M ARR solely on Bubble, and Dividend processed over $1B of business volume through entirely powered Bubble-platform.
